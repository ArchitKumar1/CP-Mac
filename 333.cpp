...
int pow_mod(int a,int b,int m= mod){int res = 1;while(b){ if(b&1) res =((LL)res*a)%m; a = ((LL)a*a)%m;b >>=1;}return res;}
/////////////////////////////////////////////
...
int main()
{
    ...
    cout << twoNumberSum({3,5,-4,8,11,1,-1,6},15) << endl;
}